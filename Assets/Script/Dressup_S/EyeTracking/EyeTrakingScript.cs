...
#endif
public class EyeTrakingScript : MonoBehaviour
{
    ...
    public float clickTime = 0.0f; //����Ʈ��ŷ���� �� 4���� �� ���� ������ �ɸ� �ð�.
    ...
    void Start()
    {
        ...
        clickTime = 0.0f; //옷을 다 없애는 데 드는 시간 초기화
    ...
    void Update()
    {
        ...
        else
        {
            ...
            Debug.Log("옷장 보일때까지 걸린 시간 : " + clickTime);
        }
...
*/
    ...
    {
        if (RandomCloth.OnStartBtn == false || RandomCloth.OnPauseBtn == true)
        {
            ...
            Debug.Log("isStart");
            RandomCloth.OnStartBtn = true;
            RandomCloth.OnPauseBtn = false;
        }  
    }
