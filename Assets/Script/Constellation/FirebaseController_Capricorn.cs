...
public class FirebaseController_Capricorn : MonoBehaviour
{
    ...
    public GameObject[] ToStar2;
    public GameObject[] ToStar3;
    public GameObject[] ToStar4;
    public GameObject[] ToStar5;
